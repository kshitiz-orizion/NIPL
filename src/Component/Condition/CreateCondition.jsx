			...
			<div>
				<div className="topHeadingContainer">
					<div className="headingCreateMachine">
						<h3>Machine/Create Condition</h3>
					</div>
					<div className="saveButtonHeader" >
						<button className="btn btn-sm btn-primary">Save Condition</button>
					</div>
...
export default reduxForm({ form: 'CreateCondition' })(CreateCondition);