			...
			<div>
				<div className="topHeadingContainer">
					<div className="headingCreateMachine">
						<h3>Subcategory/Create Subcategory</h3>
					</div>
					<div className="saveButtonHeader">
						<button className="btn btn-sm btn-primary">Save Subcategory</button>
					</div>
				...
				<div>			
								...
								<h5>{this.props.mode==='EDIT'?'Edit Subcategory':'Create Subcategory'}</h5>
								</div>
...
export default reduxForm({ form: 'CreateSubcategory' })(CreateSubcategory);