			...
			<div>
				<div className="topHeadingContainer">
					<div className="headingCreateMachine">
						<h3>Enginebrand/Create Enginebrand</h3>
					</div>
					<div className="saveButtonHeader" >
						<button className="btn btn-sm btn-primary">Save Enginebrand</button>
					</div>
				...
				<div>			
								...
								<h5>{this.props.mode==='EDIT'?'Edit Engine Brand':'Create Engine Brand'}</h5>
								</div>
