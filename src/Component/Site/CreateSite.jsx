			...
			<div>
				<div className="topHeadingContainer">
					<div className="headingCreateMachine">
						<h3>Site/Create Site</h3>
					</div>
					<div className="saveButtonHeader" >
						<button className="btn btn-sm btn-primary">Save Site</button>
					</div>
				...
				<div>			
								...
								<h5>{this.props.mode==='EDIT'?'Edit Site':'Create Site'}</h5>
								</div>
...
export default reduxForm({ form: 'CreateSite' })(CreateSite);